...
function updatePageHeader() {
  ...
  // Update PRİME LİG text colors to match logo (PRO is Dark Blue/Black, LİG is Gold)
  content = content.replace(/text-\[#1a1a2e\]">PRİME <span className="text-\[#e60000\]"/g, 'text-[#0f172a] text-[24px] md:text-[28px]">PRİME <span className="text-[#d4af37]"');
...
function updateHeader() {
  ...
  content = content.replace(/text-gray-900">PRİME <span className="text-\[#e60000\]"/g, 'text-gray-900 text-2xl">PRİME <span className="text-[#d4af37]"');
