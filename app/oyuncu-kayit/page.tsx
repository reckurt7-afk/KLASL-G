    ...
    return (
      <div className="page flex items-center justify-center px-4">
        <div className="card max-w-md w-full text-center py-16 px-8">
          ...
          <Link
            href="/takimlar"
            className="inline-block w-full py-4 bg-gradient-to-r from-[#ceaa52] to-[#8c7324] text-white font-black rounded-xl shadow-[0_8px_20px_rgba(212,175,55,0.3)] hover:shadow-[0_8px_30px_rgba(212,175,55,0.5)] transition-all text-center"
          >
            TAKIMLARA DÖN
          </Link>
        </div>
          ...
          <form onSubmit={basvuruGonder} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0d0d0d] border border-[rgba(255,255,255,0.08)] rounded-xl px-4 py-3 text-gray-400 text-sm file:mr-3 file:py-1 file:px-3 file:rounded-lg file:border-0 file:bg-[#ceaa52] file:text-white file:text-xs file:font-bold file:cursor-pointer"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0d0d0d] border border-[rgba(255,255,255,0.08)] rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-[#ceaa52] transition-colors text-sm"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-[#0d0d0d] border border-[rgba(255,255,255,0.08)] rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-[#ceaa52] transition-colors text-sm"
              >
