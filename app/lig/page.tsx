...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-transparent text-gray-900 overflow-hidden relative">
        ...
        {activeModal && (
          ...
          >
            <motion.div 
              ...
              className="relative w-full max-w-5xl max-h-[90vh] bg-white border border-gray-200 rounded-3xl p-4 sm:p-8 shadow-[0_0_60px_rgba(0,0,0,0.9)] overflow-y-auto hide-scrollbar"
            >
              
              {/* KAPAT BUTONU */}
              <button
                onClick={() => setActiveModal(null)}
                className="absolute top-4 right-4 sm:top-5 sm:right-5 w-10 h-10 rounded-full bg-white/10 hover:bg-[#ff3131] text-gray-900 flex items-center justify-center font-black text-lg transition-all duration-300 z-20 cursor-pointer"
              >
                ✕
              </button>
