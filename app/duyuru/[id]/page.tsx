...
export default async function DuyuruDetayPage({ params }: PageProps) {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-4 py-6 font-sans">
      ...
      <div className="relative w-full rounded-2xl md:rounded-3xl overflow-hidden shadow-md mb-6">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 text-white z-30">
          <div className="flex flex-wrap items-center gap-2 mb-3 text-[11px] font-bold">
            <span className="bg-[#e60000] text-white px-2 py-0.5 rounded uppercase tracking-wider">
              Ana Haber
            </span>
      ...
      {/* Özet Kutusu */}
      <div className="bg-[#f0f4f8] border-l-4 border-[#e60000] rounded-r-2xl p-5 mb-5 mt-6">
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-5 md:p-6 shadow-sm mb-5">
        <h3 className="text-[14px] font-black text-[#e60000] uppercase tracking-wider mb-4 flex items-center gap-2 border-b border-gray-100 pb-3">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-[#e60000]"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
          Haber Detayı
        </h3>
      ...
      {/* Geri Dön Butonu */}
      <Link href="/" className="inline-flex items-center gap-2 bg-[#e60000] hover:bg-[#cc0000] text-white font-black px-5 py-2.5 rounded-lg transition-all shadow-md text-[13px]">
