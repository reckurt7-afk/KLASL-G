      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-6">
        ...
        <div className="relative">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    <span className="bg-[#ceaa52] text-white text-[10px] font-bold px-2 py-1 rounded flex items-center gap-1">
          ...
          <button
            ...
            className="hidden md:flex absolute -right-3 top-1/2 -translate-y-1/2 z-10 w-9 h-9 bg-[#ceaa52] rounded-full shadow-md items-center justify-center text-white hover:bg-[#9e1b22]"
          >
