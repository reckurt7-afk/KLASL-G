          ...
          <div className="flex items-center gap-1.5">
            {haberler.map((_, i) => (
              <button
                ...
                className={`rounded-full transition-all ${i === activeIdx ? "w-6 h-2 bg-[#1e3a8a]" : "w-2 h-2 bg-gray-300"}`}
              />
            ))}
          </div>
        </div>
            ...
            {haberler.map((haber) => (
              ...
              >
                ...
                {haber.resim ? (
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-[#1a1a2e] to-[#1e3a8a]/80" />
                )}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    <span className="bg-[#1e3a8a] text-white text-[10px] font-bold px-2 py-1 rounded flex items-center gap-1">
