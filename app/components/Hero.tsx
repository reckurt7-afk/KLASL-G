...
function GoktugSponsorBox() {
  return (
    <div className="bg-[#0b2b3a] border border-[#00d0ff]/40 rounded-2xl overflow-hidden text-center flex flex-col shadow-[0_10px_30px_rgba(0,208,255,0.2)] group hover:border-[#00d0ff]/80 transition-all duration-500 relative">
      ...
      <div className="bg-gradient-to-r from-[#00d0ff] to-[#0088cc] text-white py-2 px-4 font-black text-[10px] tracking-widest relative z-10">
        👑 ANA SPONSOR
      </div>
      
      <div className="p-5 flex flex-col items-center justify-center relative z-10 min-h-[175px]">
        <div className="flex items-center gap-2 w-full justify-center group-hover:scale-105 transition-transform duration-500 mb-4">
