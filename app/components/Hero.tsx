      ...
      <div className="flex flex-col xl:flex-row justify-center w-full max-w-[1600px] mx-auto gap-8 md:gap-12 relative z-10 items-center xl:items-start pt-4 xl:pt-0">
        ...
        >
          ...
          <div className="relative group">
            <div className="absolute -inset-3 bg-gradient-to-r from-[#ceaa52] to-[#8c7324] rounded-full blur-2xl opacity-40 group-hover:opacity-70 transition duration-1000 group-hover:duration-200"></div>
            <Image
          ...
          <h1 className="text-4xl md:text-6xl font-black mt-3 leading-tight tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-gray-400 drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]">
            PRİME LİG
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ceaa52] to-[#8c7324] drop-shadow-[0_0_20px_rgba(212,175,55,0.5)]">{cityName}</span>
          </h1>

          <div className="mt-1.5 font-black text-xs md:text-sm tracking-[0.3em] text-[#ceaa52] bg-[#ceaa52]/15 px-4 py-1 rounded-full border border-[#ceaa52]/40 shadow-[0_0_15px_rgba(212,175,55,0.2)]">
            3. SEZON
          </div>

          {/* ULTRA ŞIK CANLI MAÇ KUTUSU */}
          <div className="w-full mt-6 bg-gradient-to-b from-[#0e0e0e]/95 via-[#090909]/90 to-[#050505]/95 border-2 border-[#ceaa52]/40 hover:border-[#ceaa52]/70 rounded-3xl p-6 md:p-8 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.8)] relative overflow-hidden group transition-all duration-500">
            {/* Şık Arkaplan Işığı */}
            <div className="absolute -top-24 -right-24 w-56 h-56 bg-[#ceaa52]/20 rounded-full blur-3xl group-hover:bg-[#ceaa52]/35 transition-all duration-500 pointer-events-none"></div>

            <div className="flex items-center justify-center gap-2.5 text-[#ceaa52] font-black text-xl md:text-2xl mb-6 tracking-wider">
              <span className="relative flex h-3.5 w-3.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#ceaa52] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-[#ceaa52]"></span>
              </span>
              CANLI MAÇ
            </div>
            ...
            <div className="text-gray-900 text-2xl md:text-3xl font-black leading-snug">
              {mac ? (
                <div className="flex flex-col items-center gap-2">
                  ...
                  <div className="text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-b from-[#ceaa52] via-[#e61c1c] to-[#8c7324] drop-shadow-[0_0_25px_rgba(212,175,55,0.7)] my-4 tracking-tighter">
              ...
              {mac ? (
                <div className="flex justify-around items-center">
                  <div className="flex flex-col items-center">
                    <span className="text-[#ceaa52] text-xl">⏱️</span>
                    <span className="font-black text-gray-900">{mac.current_minute}'</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="text-[#ceaa52] text-xl">📍</span>
            ...
            <a
              ...
              className={`inline-block mt-6 w-full py-4 rounded-2xl text-center font-black text-lg transition-all duration-300 ${
                mac?.youtube_link
                  ? "bg-gradient-to-r from-[#ceaa52] to-[#8c7324] text-gray-900 shadow-[0_8px_25px_rgba(212,175,55,0.4)] hover:shadow-[0_10px_35px_rgba(212,175,55,0.7)] hover:scale-[1.02]"
            ...
            {mac && olaylar.length > 0 && (
              <div className="mt-6 text-left">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-[#ceaa52]">⚡</span>
                ...
                <div className="max-h-[160px] overflow-y-auto pr-2 flex flex-col gap-2 custom-scrollbar">
                  {olaylar.map((olay, i) => (
                    <div key={i} className="flex items-center gap-3 bg-black/40 border border-gray-100 p-2.5 rounded-xl">
                      <div className="w-8 h-8 shrink-0 flex items-center justify-center bg-[#ceaa52]/10 rounded-lg text-sm font-black text-[#ceaa52]">
                        {olay.minute}'
                      </div>
          ...
          {golAnimasyon && sonGolOlay && (
            <div className="fixed inset-0 z-[9999] pointer-events-none flex items-center justify-center bg-white/80 backdrop-blur-sm animate-in fade-in duration-300">
              <div className="relative text-center scale-150 animate-bounce">
                <div className="absolute -inset-10 bg-gradient-to-r from-[#ceaa52] to-[#ff9000] blur-[100px] opacity-60"></div>
                <h1 className="text-7xl md:text-9xl font-black text-gray-900 italic drop-shadow-[0_0_40px_rgba(212,175,55,1)] transform -rotate-6 tracking-tighter" style={{ textShadow: "4px 4px 0 #000, 8px 8px 0 #ceaa52" }}>
                  GOOOOOL!
                </h1>
          ...
          <Link href="/oyunculari" className="w-full mt-6 block">
            <button className="w-full h-14 rounded-2xl bg-[#0c0c0c]/90 border border-white/15 hover:border-[#ceaa52]/60 text-gray-900 text-base md:text-lg font-black flex items-center justify-center gap-3 transition-all duration-300 shadow-xl hover:shadow-[0_0_25px_rgba(212,175,55,0.3)] hover:bg-[#151515] cursor-pointer">
          ...
          <div className="grid grid-cols-2 gap-4 w-full mt-6">
            {[
              ...
              <div
                key={index}
                className="bg-[#0b0b0b]/80 border border-gray-200 hover:border-[#ceaa52]/50 rounded-2xl p-5 backdrop-blur-md flex flex-col items-center justify-center transition-all duration-300 hover:-translate-y-1 hover:bg-[#121212] shadow-lg"
              >
                <div className="text-3xl mb-1.5 drop-shadow-md">{item.icon}</div>
                <div className="text-[#ceaa52] text-3xl font-black drop-shadow-[0_0_12px_rgba(212,175,55,0.4)]">{item.value}</div>
...
function SponsorBox({ side }: { side: "left" | "right" }) {
  return (
    <div className="bg-[#0c0c0c]/90 border border-[#ceaa52]/30 rounded-2xl overflow-hidden text-center flex flex-col shadow-[0_10px_30px_rgba(0,0,0,0.6)] backdrop-blur-xl group hover:border-[#ceaa52]/60 transition-all duration-500">
      <div className="bg-gradient-to-r from-[#ceaa52] to-[#8c7324] text-gray-900 py-2 px-4 font-black text-xs tracking-widest uppercase">
        REKLAM ALANI
      </div>
      
      <div className="p-6 md:p-8 flex flex-col items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#ceaa52]/0 to-[#ceaa52]/5 pointer-events-none group-hover:opacity-100 opacity-0 transition-opacity duration-500"></div>
        
        <div className="w-20 h-20 md:w-24 md:h-24 mb-4 bg-black rounded-full flex items-center justify-center border-2 border-dashed border-[#ceaa52]/50 text-3xl md:text-4xl group-hover:scale-110 group-hover:border-solid group-hover:border-[#ceaa52] transition-all duration-500 shadow-[0_0_15px_rgba(212,175,55,0.2)]">
          📢
        </div>

        <h3 className="m-0 mb-2 text-xl font-black text-gray-900 group-hover:text-[#ceaa52] transition-colors">
          BURAYA REKLAM VERİN
        </h3>
        ...
        <a href="https://wa.me/905010120016" target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 bg-white text-black py-3 rounded-xl font-black text-sm hover:bg-[#ceaa52] hover:text-gray-900 hover:shadow-[0_5px_20px_rgba(212,175,55,0.5)] transition-all duration-300">
