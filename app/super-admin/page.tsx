      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center justify-center">
            <span className="text-4xl font-black text-[#1e3a8a] mb-2">{cities.length}</span>
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl relative">
            ...
            <form onSubmit={handleCreateCity} className="space-y-4">
              ...
              <div>
                ...
                <input type="text" value={newCity.slug} onChange={(e) => setNewCity({...newCity, slug: e.target.value})} className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent outline-none" placeholder="istanbul" required />
              </div>
              <div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 mb-6">
              ...
              <div className="flex gap-2">
                <input 
                  ...
                  className="flex-1 border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent outline-none"
                />
                <button 
                  onClick={async () => {
