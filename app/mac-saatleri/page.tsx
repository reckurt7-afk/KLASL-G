          ...
          return (
            <div key={hafta} className="mb-12">
              ...
              {haftaninMaclari.length > 0 ? (
                ...
                <div className="w-full bg-[#151515]/50 backdrop-blur-sm border border-white/5 rounded-2xl p-8 text-center text-gray-500 font-bold italic">
                  ⏳ Bu haftanın maçları henüz planlanmadı.
                </div>
              )}
            </div>
          );
