  ...
  return (
    <div className="min-h-screen bg-[#070707] text-white p-6 pt-24">
      <div className="max-w-[1200px] mx-auto">
        <h1 className="text-3xl font-black text-[#ceaa52] mb-8 border-b border-[#ceaa52]/20 pb-4">
            ...
            {Object.keys(macGruplari).map((macId) => {
              ...
              return (
                <div key={macId} className="bg-[#111] rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
                  {/* Maç Başlığı */}
                  <div className="bg-[#1a1a1a] p-4 border-b border-[#ceaa52]/20 flex justify-between items-center">
                    <h2 className="text-sm md:text-xl font-black text-white truncate pr-2">{macId}</h2>
                    <span className="shrink-0 bg-[#ceaa52]/10 text-[#ceaa52] px-2 md:px-3 py-1 rounded-full text-[10px] md:text-xs font-bold border border-[#ceaa52]/20">
