                    ...
                    {ekip.map((kisi) => (
                      <div key={kisi.id} className="bg-white border border-gray-200 rounded-xl p-4 flex items-center gap-4 shadow-sm hover:shadow-md hover:border-gray-300 transition-all group">
                        ...
                        <button 
                          ...
                          className="w-10 h-10 flex items-center justify-center bg-gray-50 text-gray-400 rounded-lg group-hover:bg-red-50 group-hover:text-[#eab308] hover:!bg-[#eab308] hover:!text-white transition-colors"
                          title="Sil"
                        >
