...
export default function HesabimPage() {
  ...
  if (loading || !user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#070707] text-white">
        <div className="animate-spin text-[#ff3131] text-4xl">⚽</div>
      </div>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-[#070707] text-white pt-24 pb-24 px-4 overflow-hidden relative">
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[#ff3131]/10 via-[#070707]/90 to-[#070707]" />
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">
            OYUNCU <span className="text-[#ff3131]">PORTALI</span>
          </h1>
          <button 
            onClick={cikisYap}
            className="flex items-center gap-2 bg-white/10 hover:bg-[#ff3131]/80 text-white px-4 py-2 rounded-xl transition-colors font-bold text-sm"
          >
            <LogOut size={16} />
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-center lg:items-start">
          ...
          >
            ...
            <div className="relative group perspective-[1000px]">
              <div className="absolute inset-0 bg-gradient-to-tr from-[#ff3131] to-[#ffd700] blur-[40px] opacity-20 group-hover:opacity-40 transition-opacity duration-500" />
            ...
            <div className="flex gap-4 w-full">
              <button className="flex-1 bg-gradient-to-r from-[#ff3131] to-[#a11212] text-white py-3 rounded-xl font-black text-sm flex items-center justify-center gap-2 shadow-[0_4px_15px_rgba(255,49,49,0.4)] hover:scale-105 transition-transform">
          ...
          >
            ...
            <div className="bg-[#0c0c0c]/90 border border-white/10 rounded-3xl p-6 backdrop-blur-xl shadow-2xl relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#ff3131]/10 blur-[50px] rounded-full" />
