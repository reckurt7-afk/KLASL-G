...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#070707] text-white overflow-hidden relative">
      ...
      {/* POP-UP MODAL EKRANI (SAYFA ALTINDA OTOMATİK İÇERİK KALDIRILDI) */}
      {activeModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-xl animate-in fade-in duration-300">
          <div className="relative w-full max-w-5xl max-h-[90vh] bg-[#0c0c0c] border border-white/10 rounded-3xl p-4 sm:p-8 shadow-[0_0_60px_rgba(0,0,0,0.9)] overflow-y-auto hide-scrollbar">
