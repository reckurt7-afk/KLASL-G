  ...
  const subscribeUser = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        await reg.showNotification("PRÄ°ME LÄ°G", {
          body: "Bildirimler baÅŸarÄ±yla aÃ§Ä±ldÄ±! MaÃ§ sonuÃ§larÄ± ve haberler anÄ±nda cebinizde.",
          icon: "/icons/prime-logo.jpg",
          vibrate: [200, 100, 200]
        } as any);
        // alert("Bildirimler baÅŸarÄ±yla aÃ§Ä±ldÄ±! MaÃ§ sonuÃ§larÄ± ve haberler anÄ±nda cebinizde.");
      } else {
    ...
    <div className="min-h-screen bg-white text-[#1a1a2e] font-sans overflow-x-hidden selection:bg-red-100">
      ...
      <header className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 h-[70px] md:h-[76px] flex items-center shadow-sm">
        <div className="w-full max-w-[1400px] mx-auto px-5 md:px-8 flex items-center justify-end relative h-full">
          ...
          {/* Orta KÄ±sÄ±m - Logo (Tam Merkeze Sabitlendi) */}
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center bg-black pt-[90px] pb-16 overflow-hidden">
        ...
        {/* Hafif Karartma (Sadece yazÄ±larÄ±n okunabilmesi iÃ§in Ã§ok ince bir siyah katman) */}
        ...
        <div className="relative z-10 flex flex-col items-center text-center w-full max-w-[1000px] mx-auto px-5 gap-6">
          ...
          <div className="border border-[#9e1b22]/30 bg-black/50 backdrop-blur-md rounded-full px-4 py-1.5 flex items-center justify-center gap-2 shadow-lg">
            ...
            <span className="text-white/90 text-[10px] md:text-[12px] font-bold tracking-widest uppercase">TÃ¼rkiye&apos;nin #1 Platformu</span>
          </div>

          {/* Center Logo - Bullet Crop */}
          <div className="relative flex items-center justify-center my-4 mt-8 md:mt-12 group">
            {/* Arka plan parlamasÄ± (AltÄ±n rengi) */}
          ...
          <div className="flex flex-col items-center w-full max-w-[320px] md:max-w-[400px]">
            ...
            <p className="text-white/70 text-[13px] md:text-[15px] font-medium text-center mt-4 leading-relaxed">
              MaÃ§ sonuÃ§larÄ±, puan durumlarÄ±, takÄ±mlar ve Ã¶zel haberlere telefonundan anÄ±nda ulaÅŸ.
            </p>
          </div>
          ...
          <div className="flex flex-row flex-wrap items-center justify-center gap-2 md:gap-4 w-full mt-2">
            <div className="border border-white/10 bg-white/10 backdrop-blur-md rounded-xl px-4 py-2.5 flex items-center justify-center gap-2 shadow-sm">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ceaa52" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
              <span className="text-white font-bold text-[13px] md:text-[15px]">40 Åehir</span>
            </div>
            <div className="border border-white/10 bg-white/10 backdrop-blur-md rounded-xl px-4 py-2.5 flex items-center justify-center gap-2 shadow-sm">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ceaa52" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
              <span className="text-white font-bold text-[13px] md:text-[15px]">16.364+ Oyuncu</span>
            </div>
            <div className="border border-white/10 bg-white/10 backdrop-blur-md rounded-xl px-4 py-2.5 flex items-center justify-center gap-2 shadow-sm">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ceaa52" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M8 21h8"></path><path d="M12 17v4"></path><path d="M7 4h10l1 13H6L7 4z"></path></svg>
              <span className="text-white font-bold text-[13px] md:text-[15px]">1.395+ TakÄ±m</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-[360px] md:max-w-[440px] mt-6">
            <Link 
              href="/lig" 
              className="col-span-1 sm:col-span-2 bg-gradient-to-r from-[#9e1b22] to-[#b30000] hover:from-[#ceaa52] hover:to-[#9e1b22] text-white font-bold text-[16px] h-[52px] rounded-xl transition-all flex items-center justify-center gap-2 shadow-[0_8px_20px_rgba(158,27,34,0.3)] hover:-translate-y-1"
            >
              Platformu KeÅŸfet
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="w-full aspect-[2/1] md:aspect-[2.5/1] bg-white rounded-3xl flex flex-col items-center justify-center border border-gray-100 shadow-[0_10px_40px_rgba(0,0,0,0.03)] relative overflow-hidden mb-16 p-8">
             ...
             <div className="relative z-10 flex flex-col items-center">
               ...
               <h3 className="text-[26px] font-black text-[#1a1a2e]">TÃ¼rkiye Futbol HaritasÄ±</h3>
             </div>
          </div>

          <div className="text-center mb-10">
            <h3 className="text-[14px] font-medium text-gray-500 mb-1">Prime Lig AvantajlarÄ±</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#f8f9fa] border border-gray-100 rounded-xl p-8 text-center flex flex-col items-center">
              ...
              <h4 className="font-bold text-[13px] text-[#1a1a2e] mb-3 uppercase tracking-wide">SON TEKNOLOJÄ° HALI SAHALAR</h4>
              <p className="text-gray-500 text-[13px] leading-relaxed">En Ã¼st dÃ¼zey futbol deneyimini sunmak iÃ§in tasarlanmÄ±ÅŸ en kaliteli sahalarda oynamanÄ±n keyfini Ã§Ä±karÄ±n.</p>
            </div>
            ...
            <div className="bg-[#f8f9fa] border border-gray-100 rounded-xl p-8 text-center flex flex-col items-center">
              ...
              <p className="text-gray-500 text-[13px] leading-relaxed">MaÃ§larÄ±mÄ±z, fair play ve kurallara uyulmasÄ±nÄ± saÄŸlayan sertifikalÄ± hakemler tarafÄ±ndan yÃ¶netilmektedir.</p>
            </div>
            ...
            <div className="bg-[#ffe5e5] border border-[#ffcccc] rounded-xl p-8 text-center flex flex-col items-center">
              ...
              <h4 className="font-bold text-[13px] text-[#1a1a2e] mb-3 uppercase tracking-wide">CANLI MAÃ‡ YAYINI</h4>
              <p className="text-gray-700 text-[13px] leading-relaxed">TÃ¼m lig maÃ§larÄ±nÄ±n canlÄ± yayÄ±nÄ± ve Ã¶zet gÃ¶rÃ¼ntÃ¼leri ile aksiyonun hiÃ§bir anÄ±nÄ± kaÃ§Ä±rmayacaksÄ±nÄ±z.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-28 bg-[#fafbfc] w-full">
        <div className="max-w-[900px] mx-auto px-6 flex flex-col items-center">
          ...
          <p className="text-gray-500 text-[15px] mb-14">TÃ¼rkiye'nin en kapsamlÄ± halÄ± saha futbol platformu</p>
          ...
          <div className="w-full bg-white rounded-3xl shadow-[0_20px_50px_rgba(158,27,34,0.06)] border border-[#ffcccc]/30 p-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 divide-y md:divide-y-0 md:divide-x divide-gray-100">
              ...
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <div className="text-[14px] font-bold text-[#1a1a2e]">Ä°l</div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center text-center pt-10 md:pt-0">
                ...
                <div className="text-[14px] font-bold text-[#1a1a2e]">TakÄ±m</div>
              </div>
            ...
            <div className="w-full text-center mt-12 pt-6 border-t border-gray-100">
              <span className="text-[12px] font-medium text-gray-500">TÃ¼rkiye'nin en kapsamlÄ± halÄ± saha futbol platformu</span>
            </div>
          </div>
        </div>
      </section>

      {/* Ã–ZELLÄ°KLER - NELER SUNUYORUZ */}
      <section className="py-24 bg-white w-full">
        <div className="max-w-[1200px] mx-auto px-6 flex flex-col items-center">
          ...
          <p className="text-gray-500 text-[15px] mb-12">HalÄ± saha futbolunda ihtiyacÄ±nÄ±z olan her ÅŸey</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
            ...
            <div className="bg-[#f0f9f4] rounded-xl p-8 flex flex-col border border-[#e2f2e9]">
              ...
              <p className="text-gray-600 text-[13px] leading-relaxed">40 ÅŸehirde aktif ligleri takip et, puan durumunu incele</p>
            </div>
            ...
            <div className="bg-[#fff9f5] rounded-xl p-8 flex flex-col border border-[#faefe8]">
              ...
              <h3 className="text-[18px] font-bold text-[#1a1a2e] mb-3">TakÄ±m Profilleri</h3>
              <p className="text-gray-600 text-[13px] leading-relaxed">TakÄ±mlarÄ± keÅŸfet, istatistiklerini incele, kadrolarÄ± gÃ¶r</p>
            </div>
            ...
            <div className="bg-[#fff5f5] rounded-xl p-8 flex flex-col border border-[#fce8e8]">
              ...
              <h3 className="text-[18px] font-bold text-[#1a1a2e] mb-3">MaÃ§ SonuÃ§larÄ±</h3>
              <p className="text-gray-600 text-[13px] leading-relaxed">CanlÄ± skorlarÄ± takip et, maÃ§ detaylarÄ±nÄ± incele</p>
            </div>
            ...
            <div className="bg-[#f0f9f4] rounded-xl p-8 flex flex-col border border-[#e2f2e9]">
              ...
              <h3 className="text-[18px] font-bold text-[#1a1a2e] mb-3">Oyuncu Ä°statistikleri</h3>
              <p className="text-gray-600 text-[13px] leading-relaxed">En iyi oyuncularÄ± keÅŸfet, performanslarÄ± karÅŸÄ±laÅŸtÄ±r</p>
            </div>
            ...
            <div className="bg-[#fff9f5] rounded-xl p-8 flex flex-col border border-[#faefe8]">
              ...
              <h3 className="text-[18px] font-bold text-[#1a1a2e] mb-3">GÃ¼ncel Haberler</h3>
              <p className="text-gray-600 text-[13px] leading-relaxed">BÃ¶lgesel ve ulusal halÄ± saha haberleri</p>
            </div>
            ...
            <div className="bg-[#fff5f5] rounded-xl p-8 flex flex-col border border-[#fce8e8]">
              ...
              <h3 className="text-[18px] font-bold text-[#1a1a2e] mb-3">AnlÄ±k Bildirimler</h3>
              <p className="text-gray-600 text-[13px] leading-relaxed">Favori takÄ±mlarÄ±ndan anlÄ±k bildirimler al</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#fafbfc] w-full flex justify-center px-6">
        <div className="w-full max-w-[800px] bg-white rounded-2xl shadow-[0_30px_60px_rgba(0,0,0,0.04)] border border-gray-100 p-14 text-center">
          <h2 className="text-[44px] font-black text-[#1a1a2e] mb-4 tracking-tight">Hemen BaÅŸla!</h2>
          <p className="text-gray-500 text-[15px] mb-10 max-w-md mx-auto leading-relaxed">
            HalÄ± saha futbolunun en heyecanlÄ± platformuna katÄ±l! Ligini takip et, istatistikleri keÅŸfet, topluluÄŸa dahil ol.
          </p>
          <Link href="/giris" className="inline-flex items-center gap-2 bg-white text-[#1a1a2e] font-bold text-[14px] px-8 py-3.5 rounded-lg shadow-[0_5px_15px_rgba(0,0,0,0.06)] border border-gray-200 hover:bg-gray-50 transition-colors">
            Åimdi GiriÅŸ Yap <span className="text-lg font-black ml-1">{'>'}</span>
          </Link>
        </div>
      </section>
      ...
      <footer className="bg-white py-16 px-6 border-t border-gray-100 flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-10 text-[12px] font-bold text-gray-400">
          <a href="#" className="hover:text-[#1a1a2e] transition-colors">Ä°letiÅŸim</a>
          <span className="text-gray-300">â€¢</span>
          <a href="#" className="hover:text-[#1a1a2e] transition-colors">Lig KurallarÄ±</a>
          <span className="text-gray-300">â€¢</span>
          <a href="#" className="hover:text-[#1a1a2e] transition-colors">Gizlilik PolitikasÄ±</a>
        </div>
        
        <div className="text-gray-400 text-[11px] mb-4 text-center">
          Â© 2026 PRÄ°ME LÄ°G. TÃ¼m HaklarÄ± SaklÄ±dÄ±r
          <br/>
          <span className="inline-block mt-2">HalÄ± saha futbolunun TÃ¼rkiye'deki en bÃ¼yÃ¼k platformu</span>
        </div>
        
        <div className="text-gray-400 text-[10px] mt-6 pt-6 border-t border-gray-100 w-full max-w-sm text-center">
          Bu site <a href="https://www.agx-labs.com/" className="text-gray-500 font-bold hover:text-[#9e1b22]">AGX Labs</a> tarafÄ±ndan geliÅŸtirilmiÅŸtir
        </div>
      </footer>
