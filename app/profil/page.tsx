      ...
      <div className="container max-w-2xl">
        ...
        <div className="card p-8 mb-6">
          <div className="flex items-center gap-6 mb-8">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#ceaa52] to-[#8c7324] flex items-center justify-center text-white text-3xl font-black shadow-[0_0_20px_rgba(212,175,55,0.3)] shrink-0 overflow-hidden">
              {profil.avatar_url ? (
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                {user.email === "reckurt7@gmail.com" ? (
                  ...
                  <p className="text-[#ceaa52] text-xs font-bold tracking-widest uppercase">Prime Lig Üyesi</p>
                )}
