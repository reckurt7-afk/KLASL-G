        ...
        <div style={{ textAlign: "center", marginBottom: 30 }}>
          <div style={{ position: "relative", width: 90, height: 90, margin: "0 auto 15px" }}>
            <Image
              ...
              alt="PRİME LİG"
              fill
              className="rounded-full object-cover scale-[1.1] bg-white border-2 border-[#ceaa52]" style={{ filter: "drop-shadow(0 0 10px rgba(0,0,0,0.1))" }}
            />
          </div>
          <h1 style={{
            color: "#1a1a1a",
        ...
        <div style={{
          ...
          {hata && (
            <div style={{
              ...
              borderRadius: 12, padding: "14px 18px", color: "#9e1b22", fontSize: 14, fontWeight: 600, marginBottom: 24,
            }}>
              🚨 {hata}
            </div>
          )}
          ...
          <form onSubmit={kayitOl}>
            ...
            <div className="mb-6">
              <label style={labelStyle} className="flex items-center gap-2">
                <ShieldCheck size={16} className="text-[#ceaa52]" />
              ...
              <label className="flex items-start gap-3 cursor-pointer group bg-gray-50 p-4 rounded-xl border border-gray-200 hover:border-gray-300 transition-colors">
                <input 
                  ...
                  className="mt-1 w-5 h-5 rounded border-gray-300 text-[#ceaa52] focus:ring-[#9e1b22]"
                />
                <div>
            ...
            <button
              ...
              style={{
                width: "100%",
                padding: "18px",
                background: (loading || basarili) ? "#f87171" : "#9e1b22",
                color: "#fff",
                border: "none",
                borderRadius: 14,
                fontSize: 17,
