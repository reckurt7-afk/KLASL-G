      ...
      <div className="page flex items-center justify-center px-4">
        <div className="card max-w-md w-full text-center py-16 px-8">
          ...
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-[#ceaa52] to-[#8c7324] text-white font-black rounded-xl shadow-[0_8px_20px_rgba(212,175,55,0.3)] hover:shadow-[0_8px_30px_rgba(212,175,55,0.5)] transition-all"
          >
            YENİ BAŞVURU YAP
          </button>
        </div>
          ...
          <form onSubmit={gonder} className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-[#0d0d0d] border border-[rgba(255,255,255,0.08)] rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-[#ceaa52] transition-colors text-sm resize-none"
              />
            </div>
