  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-fixed relative" style={{ backgroundImage: "url('/images/stadium.png')" }}>
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto pt-[40px] px-4 pb-24">
        ...
        <div className="bg-[#151515]/60 backdrop-blur-xl border border-[#ceaa52]/20 rounded-3xl p-6 mb-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
          <h1 className="text-white text-3xl md:text-4xl font-black m-0 drop-shadow-[0_0_15px_rgba(212,175,55,0.4)]">
            📋 ESAME LİSTESİ
          </h1>
          <div className="text-[#ceaa52] mt-2 text-xs md:text-sm tracking-[0.4em] font-black uppercase">
            Kaptan Kadro Seçimi
          </div>
        </div>
          ...
          {haftalar.map((_, i) => (
            <button
              ...
              className={`flex-shrink-0 w-12 h-12 rounded-full font-black text-lg transition-all duration-300 shadow-[0_5px_15px_rgba(0,0,0,0.3)]
                ${aktifHafta === i 
                  ? "bg-gradient-to-br from-[#ceaa52] to-[#8c7324] text-white scale-110 shadow-[0_0_15px_rgba(212,175,55,0.6)]" 
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="h-[2px] flex-1 bg-gradient-to-r from-transparent to-[#ceaa52]/50"></div>
          ...
          <div className="h-[2px] flex-1 bg-gradient-to-l from-transparent to-[#ceaa52]/50"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {haftalar[aktifHafta].maclar.map((mac, index) => (
            <div
              key={index}
              className="group relative bg-[#151515]/70 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:border-[#ceaa52]/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_15px_30px_rgba(212,175,55,0.15)] flex flex-col"
            >
              <div className="absolute inset-0 bg-gradient-to-b from-[#ceaa52]/0 to-[#ceaa52]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-2xl"></div>
              ...
              <div className="flex justify-between items-center w-full mb-6">
                <div className="flex flex-col items-center gap-2 w-[40%] text-center">
                  <div className="relative w-[50px] h-[50px] md:w-[70px] md:h-[70px] group-hover:scale-110 transition-all duration-500 drop-shadow-[0_0_15px_rgba(212,175,55,0.3)]">
                    <Image src={logolar[mac[0]] || "/icons/prime-logo.jpg"} alt={mac[0]} fill className="object-contain" />
                  </div>
                  <span className="text-white font-bold text-sm md:text-base">{mac[0]}</span>
                </div>

                <span className="text-[#ceaa52] font-black text-2xl italic drop-shadow-[0_0_10px_rgba(212,175,55,0.8)] w-[20%] text-center">VS</span>

                <div className="flex flex-col items-center gap-2 w-[40%] text-center">
                  <div className="relative w-[50px] h-[50px] md:w-[70px] md:h-[70px] group-hover:scale-110 transition-all duration-500 drop-shadow-[0_0_15px_rgba(212,175,55,0.3)]">
                    <Image src={logolar[mac[1]] || "/icons/prime-logo.jpg"} alt={mac[1]} fill className="object-contain" />
                  </div>
              ...
              <button
                ...
                className="w-full py-3 bg-[#222] hover:bg-gradient-to-r hover:from-[#ceaa52] hover:to-[#8c7324] border border-white/10 hover:border-transparent text-gray-300 hover:text-white rounded-xl font-black shadow-lg transition-all duration-300 flex items-center justify-center gap-2"
              >
                📝 KADRO OLUŞTUR
              </button>
            </div>
        ...
        {authAcik && secilenMac && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-start md:items-center justify-center z-[99999] p-4 overflow-y-auto">
            <div className="w-full max-w-2xl bg-[#111] border border-[#ceaa52]/30 rounded-3xl p-6 shadow-[0_20px_50px_rgba(0,0,0,0.8)] my-8">
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={() => setAuthAcik(false)} className="text-gray-400 hover:text-[#ceaa52] text-2xl font-black transition-colors">&times;</button>
              </div>
              ...
              {!isAuth ? (
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="text-[#ceaa52] font-bold text-sm mb-2 block">Takımınız</label>
                    <select
                      value={secilenTakim}
                      onChange={(e) => setSecilenTakim(e.target.value)}
                      className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-4 py-3 text-white font-bold focus:outline-none focus:border-[#ceaa52]/50"
                    >
                  ...
                  <div>
                    <label className="text-[#ceaa52] font-bold text-sm mb-2 block">Kaptan Şifresi</label>
                    <input
                      type="password"
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-[#ceaa52] to-[#8c7324] text-white rounded-xl font-black shadow-[0_5px_15px_rgba(212,175,55,0.3)] hover:shadow-[0_5px_20px_rgba(212,175,55,0.6)] transition-all"
                  >
                ...
                <div className="space-y-6">
                  <div className="bg-[#1a1a1a] p-4 rounded-xl border border-[#ceaa52]/20 flex items-center justify-between">
                    <div>
                      <div className="text-[#ceaa52] font-black text-xs tracking-widest">{secilenMac.hafta}</div>
                    ...
                    <>
                      ...
                      <div className="max-h-[50vh] overflow-y-auto pr-2 space-y-2 custom-scrollbar">
                        {oyuncular.map((o) => {
                          ...
                          return (
                            <div key={o.id} className={`p-3 rounded-xl border transition-colors ${asilMi ? 'bg-[#ceaa52]/10 border-[#ceaa52]/30' : yedekMi ? 'bg-white/5 border-white/20' : 'bg-[#1a1a1a] border-white/5'}`}>
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                ...
                                <div className="grid grid-cols-3 gap-2 mt-1 sm:mt-0 sm:flex sm:flex-wrap sm:justify-end">
                                  <button
                                    ...
                                    className={`w-full sm:w-auto px-1 py-2 sm:px-3 sm:py-1.5 rounded-lg text-[10px] sm:text-xs font-bold transition-colors ${asilMi ? 'bg-[#ceaa52] text-white shadow-lg' : 'bg-[#222] text-gray-400 hover:bg-[#333]'}`}
                                  >
                                    İlk 7
                                  </button>
                                  <button
