...
export default function IstatistiklerPage() {
  ...
  return (
    <div className="min-h-screen bg-[#070707] text-white pt-24 pb-20 px-4 font-sans selection:bg-[#eab308]/30 relative overflow-hidden">
      {/* Background Effects */}
      <div className="absolute top-0 left-0 w-full h-[600px] bg-gradient-to-b from-[#ceaa52]/10 via-[#ceaa52]/5 to-transparent pointer-events-none" />
      <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#ceaa52] rounded-full blur-[150px] opacity-10 pointer-events-none" />
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center mb-12">
          <motion.div 
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="w-16 h-16 bg-gradient-to-br from-[#ceaa52] to-[#991b1b] rounded-2xl flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(212,175,55,0.4)]"
          >
          ...
          >
            Prime Lig Bursa'nın en iyileri. Sahada parlayan yıldızlar, golcüler, asist kralları ve hırçınlar.
          </motion.p>
        </div>
        ...
        {loading && (
          <div className="flex justify-center items-center py-20">
            <div className="w-12 h-12 border-4 border-[#ceaa52]/20 border-t-[#ceaa52] rounded-full animate-spin" />
          </div>
        )}
                  ...
                  {statsData.slice(3).map((stat, idx) => (
                    ...
                    >
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          <h4 className="font-bold text-white text-[15px] group-hover:text-[#ceaa52] transition-colors">{stat.isim}</h4>
