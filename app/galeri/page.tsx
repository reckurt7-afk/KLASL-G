              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="w-14 h-14 rounded-full bg-[#ceaa52]/80 backdrop-blur-sm flex items-center justify-center text-white text-2xl shadow-[0_0_20px_rgba(212,175,55,0.5)]">
                      🔍
                    </div>
                  </div>
                </div>
      ...
      {secili && (
        ...
        >
          ...
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/10 border border-white/20 text-white text-2xl flex items-center justify-center hover:bg-[#ceaa52]/60 transition-colors z-10"
          >
            ←
          </button>
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/10 border border-white/20 text-white text-2xl flex items-center justify-center hover:bg-[#ceaa52]/60 transition-colors z-10"
          >
            →
          </button>
        </div>
