...
// Fix Header layout: center the PRO LIG text and keep logo left (pushed slightly right)
page = page.replace(
  /<Link href="\/" className="flex items-center gap-4 md:gap-5 shrink-0">([\s\S]*?)<Image src="\/icons\/logo\.png" width=\{64\} height=\{64\} alt="Pro Lig Logo" className="rounded-full object-contain md:w-\[70px\] md:h-\[70px\]" \/>\s*<span className="font-black text-\[#0f172a\] text-\[26px\] md:text-\[30px\] tracking-tighter">PRO <span className="text-\[#d4af37\]">LİG<\/span><\/span>\s*<\/Link>/i,
